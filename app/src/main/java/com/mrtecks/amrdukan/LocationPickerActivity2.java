...
public class LocationPickerActivity2 extends AppCompatActivity implements OnMapReadyCallback {

    private static final int REQUEST_CHECK_SETTINGS = 2;
    private final String TAG = LocationPickerActivity2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imgCurrentloc = findViewById(com.shivtechs.maplocationpicker.R.id.imgCurrentloc);
        Button txtSelectLocation = findViewById(com.shivtechs.maplocationpicker.R.id.fab_select_location);
        ImageView directionTool = findViewById(com.shivtechs.maplocationpicker.R.id.direction_tool);
        ImageView googleMapTool = findViewById(com.shivtechs.maplocationpicker.R.id.google_maps_tool);

        imgSearch = findViewById(com.shivtechs.maplocationpicker.R.id.imgSearch);
        addressline2 = findViewById(com.shivtechs.maplocationpicker.R.id.addressline2);
        citydetail = findViewById(com.shivtechs.maplocationpicker.R.id.citydetails);
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.shivtechs.maplocationpicker.R.id.map);
        if (mapFragment != null) {
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!Places.isInitialized()) {
                    Places.initialize(LocationPickerActivity2.this.getApplicationContext(),MapUtility.apiKey);
                }
                ...
                Intent intent = new Autocomplete.IntentBuilder(
                        ...
                        .build(LocationPickerActivity2.this);
                LocationPickerActivity2.this.startActivityForResult(intent, PLACE_AUTOCOMPLETE_REQUEST_CODE);
            }
        });
        ...
        txtSelectLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("addressasdasd", addressasdasd);//if you want place url
                LocationPickerActivity2.this.setResult(Activity.RESULT_OK, intent);
        ...
        imgCurrentloc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LocationPickerActivity2.this.showCurrentLocationOnMap(false);
        ...
        directionTool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LocationPickerActivity2.this.showCurrentLocationOnMap(true);
        ...
        googleMapTool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LocationPickerActivity2.this.startActivity(intent);
            }
        });

        try {
            Toast.makeText(getApplicationContext(),this.getResources().getString(com.shivtechs.maplocationpicker.R.string.edittext_hint),Toast.LENGTH_SHORT).show();
        }catch (Exception e){
            Toast.makeText(this,this.getResources().getString(com.shivtechs.maplocationpicker.R.string.edittext_hint),Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PLACE_AUTOCOMPLETE_REQUEST_CODE) {
            ...
            if (resultCode != RESULT_OK) {
                ...
                Toast.makeText(LocationPickerActivity2.this, "Location Not Available..", Toast.LENGTH_SHORT).show();
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        ...
                        if (isDirectionClicked) {
                            ...
                            LocationPickerActivity2.this.getAddressByGeoCodingLatLng();
                        }

                    } else {
                        //Gps not enabled if loc is null
                        LocationPickerActivity2.this.getSettingsLocation();
                        Toast.makeText(LocationPickerActivity2.this, "Location not Available", Toast.LENGTH_SHORT).show();
...
//                getSettingsLocation();
                    Toast.makeText(LocationPickerActivity2.this, "Location Not Availabe", Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker arg0) {
                View v = getLayoutInflater().inflate(com.shivtechs.maplocationpicker.R.layout.info_window_layout, null);

                // Getting the position from the marker
                LatLng latLng = arg0.getPosition();
                mLatitude = latLng.latitude;
                mLongitude = latLng.longitude;
                TextView tvLat = v.findViewById(com.shivtechs.maplocationpicker.R.id.address);
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                Log.e("latlng", latLng + "");
                isZooming=true;
                LocationPickerActivity2.this.addMarker();
                if (!MapUtility.isNetworkAvailable(LocationPickerActivity2.this)) {
                    MapUtility.showToast(LocationPickerActivity2.this, "Please Connect to Internet");
                }
                LocationPickerActivity2.this.getAddressByGeoCodingLatLng();
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                try {
                    ...
                    if (response != null) {
                        ...
                        LocationPickerActivity2.this.startLocationUpdates();
    ...
    private void getAddressByGeoCodingLatLng() {
        ...
        if (mLatitude != 0 && mLongitude != 0) {
            ...
            LocationPickerActivity2.GetAddressFromLatLng asyncTask = new LocationPickerActivity2.GetAddressFromLatLng();
    ...
    private void getLatLngByRevGeoCodeFromAdd() {
        ...
        if (mLatitude == 0 && mLongitude == 0) {
            ...
            filterTaskList.clear();
            LocationPickerActivity2.GetLatLngFromAddress asyncTask = new LocationPickerActivity2.GetLatLngFromAddress();
            filterTaskList.add(asyncTask);
    ...
    private class GetAddressFromLatLng extends AsyncTask<Double, Void, Bundle> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            MapUtility.showProgress(LocationPickerActivity2.this);
        }
        ...
        protected Bundle doInBackground(Double... doubles) {
            try {
                ...
                geocoder = new Geocoder(LocationPickerActivity2.this, Locale.getDefault());
        ...
        protected void onPostExecute(Bundle userAddress) {
            ...
            LocationPickerActivity2.this.userAddress = userAddress.getString("fulladdress");
            LocationPickerActivity2.this.userCity = userAddress.getString("city");
            ccii = userAddress.getString("city");
            LocationPickerActivity2.this.userState = userAddress.getString("state");
            LocationPickerActivity2.this.userPostalCode = userAddress.getString("postalcode");
            LocationPickerActivity2.this.userCountry = userAddress.getString("country");
            LocationPickerActivity2.this.userAddressline2 = userAddress.getString("addressline2");
            MapUtility.hideProgress();
            addMarker();
        }
    }
    ...
    private class GetLatLngFromAddress extends AsyncTask<String, Void, LatLng> {
        ...
        protected void onPostExecute(LatLng latLng) {
            ...
            LocationPickerActivity2.this.mLatitude = latLng.latitude;
            LocationPickerActivity2.this.mLongitude = latLng.longitude;
            MapUtility.hideProgress();
            addMarker();
        }
    }
